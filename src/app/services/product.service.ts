  ...
  constructor() {
    ...
    this.products = JSON.parse(
      `{
        "AV300-1006": {
          "id": "AV300-1006",
          "name": "Slangupprullare Avfettning 10m",
          "children": [],
          "extra": {
            "AGA": {
              "APE": "      1",
        ...
        "AV430-1506": {
          "id": "AV430-1506",
          "name": "Slangupprullare Avfettning 15m",
          "children": [],
          "extra": {
            "AGA": {
              "APE": "      1",
        ...
        "VXL-10WK": {
          "id": "VXL-10WK",
          "name": "Upprullare för avspärrning 10 m",
          "children": [],
          "extra": {
            "AGA": {
              "APE": "      1",
        ...
        "VXL-15WK": {
          "id": "VXL-15WK",
          "name": "Upprullare för avspärrning 15 m",
          "children": [],
          "extra": {
            "AGA": {
              "APE": "      1",
        ...
        "VXL-20WK": {
          "id": "VXL-20WK",
          "name": "Upprullare för avspärrning 20 m",
          "children": [],
          "extra": {
            "AGA": {
              "APE": "      1",
        ...
        "8430-802": {
          "id": "8430-802",
          "name": "Slanguppr. för Butan & Propan med 20m",
          "children": [],
          "extra": {
            "AGA": {
              "APE": "      1",
        ...
        "8430-804": {
          "id": "8430-804",
          "name": "Slanguppr. för Butan & Propan med 18m",
          "children": [],
          "extra": {
            "AGA": {
              "APE": "      1",
